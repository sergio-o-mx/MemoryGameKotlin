...
public abstract class ActivityGame2Binding extends ViewDataBinding {
  ...
  protected ActivityGame2Binding(Object _bindingComponent, View _root, int _localFieldCount,
   ...
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_game_2, root, attachToRoot, component)
   */
  @NonNull
  @Deprecated
  public static ActivityGame2Binding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
    return ViewDataBinding.<ActivityGame2Binding>inflateInternal(inflater, com.ioconnectservices.memorygamekotlin.R.layout.activity_game_2, root, attachToRoot, component);
  }
   ...
   * compilation fails for another reason.
   * https://issuetracker.google.com/issues/116541301
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_game_2, null, false, component)
   */
  @NonNull
  @Deprecated
  public static ActivityGame2Binding inflate(@NonNull LayoutInflater inflater,
      @Nullable Object component) {
    return ViewDataBinding.<ActivityGame2Binding>inflateInternal(inflater, com.ioconnectservices.memorygamekotlin.R.layout.activity_game_2, null, false, component);
  }

  public static ActivityGame2Binding bind(@NonNull View view) {
   ...
   */
  @Deprecated
  public static ActivityGame2Binding bind(@NonNull View view, @Nullable Object component) {
    return (ActivityGame2Binding)bind(component, view, com.ioconnectservices.memorygamekotlin.R.layout.activity_game_2);
  }
}
