...
public abstract class FragmentGame2Binding extends ViewDataBinding {
  ...
  protected FragmentGame2Binding(Object _bindingComponent, View _root, int _localFieldCount,
   ...
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.fragment_game_2, root, attachToRoot, component)
   */
  @NonNull
  @Deprecated
  public static FragmentGame2Binding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
    return ViewDataBinding.<FragmentGame2Binding>inflateInternal(inflater, R.layout.fragment_game_2, root, attachToRoot, component);
  }
   ...
   * compilation fails for another reason.
   * https://issuetracker.google.com/issues/116541301
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.fragment_game_2, null, false, component)
   */
  @NonNull
  @Deprecated
  public static FragmentGame2Binding inflate(@NonNull LayoutInflater inflater,
      @Nullable Object component) {
    return ViewDataBinding.<FragmentGame2Binding>inflateInternal(inflater, R.layout.fragment_game_2, null, false, component);
  }

  public static FragmentGame2Binding bind(@NonNull View view) {
   ...
   */
  @Deprecated
  public static FragmentGame2Binding bind(@NonNull View view, @Nullable Object component) {
    return (FragmentGame2Binding)bind(component, view, R.layout.fragment_game_2);
  }
}
